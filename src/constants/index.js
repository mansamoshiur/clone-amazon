export  const allitems=[
    ...
    {
      _id:200, title:"All Departments"
    },
    {
      _id:300, title:"All Departments"
    },
    {
      _id:400, title:"All Departments"
    }
  ]
  export const middleList =[
    {_id:111, title:"Get to Know  Us", listItem:[{_id:"001",listData:[
      "Careers",
      "Blog",
      "About Amazon",
      "Investor Relations",
    ...
    {_id:112, title:"Make Money with Us", listItem:[{_id:"002",listData:[
    ...
    {_id:113, title:"Amazon Payment Products", listItem:[{_id:"003",listData:[
    ...
    {_id:114, title:"Let Us Help You", listItem:[{_id:"004",listData:[
      "Amazon and COVID-19",
      "Your Account",
      "About Amazon",
      "Investor Relations",
