...
const Products = () => {
  ...
  return (
    <div className='max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 lgl:grid-cols-4 gap-6 lgl:gap-10'>
        {
            productData.map((item)=>(
                <div key={item.id} className='bg-white h-auto border-[1px] border-gray-200 py-8 z-30 hover:border-transparent shadow-none hover:shadow-testShadow duration-200 flex flex-col gap-4 relative'>
                    ...
                    <div className='w-full h-auto flex justify-center items-center relative group'>
                        ...
                        <ul className='w-full h-36 bg-gray-100 absolute bottom-[-170px] flex flex-col items-end justify-center gap-2 font-titleFont px-2 border-r border-1 group-hover:bottom-0 duration-500'>
